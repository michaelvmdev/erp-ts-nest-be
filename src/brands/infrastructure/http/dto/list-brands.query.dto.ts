...
/**
 * Parametros de `GET /brands`.
 *
 * A diferencia del filtro de productos, aqui viajan en la query string: son
 * planos, pocos y de solo lectura, asi que un GET cacheable es lo natural.
 *
...
export class ListBrandsQueryDto {
  ...
  @IsBoolean({ message: 'brandActive debe ser "true" o "false".' })
  brandActive?: boolean;
  ...
  @ApiPropertyOptional({
    ...
    example: 50,
    description:
      'Tamano de pagina. El valor por defecto es 50 y no 20 porque las marcas suelen ' +
