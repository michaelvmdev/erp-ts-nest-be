...
/**
 * Parametros de `GET /dashboard/monthly-purchases-by-category`.
 */
export class MonthlyPurchasesByCategoryQueryDto {
  @ApiProperty({
    type: 'integer',
    minimum: 2000,
    maximum: 2100,
  ...
  @ApiProperty({
    ...
    description: 'Categoria de la que se agregan las compras.',
  })
