...
import { SendClientSalesAmountReportOutput } from '../../../application/send-client-sales-amount-report-pdf.use-case';

export class SendClientSalesAmountReportEmailResponseDto {
  @ApiProperty({
    format: 'email',
  ...
  static fromOutput(
    output: SendClientSalesAmountReportOutput,
  ): SendClientSalesAmountReportEmailResponseDto {
    const dto = new SendClientSalesAmountReportEmailResponseDto();
    dto.to = output.to;
